                                ...
                                <div class="user-info-wrapper">
                                    ...
                                    <div class="d-flex flex-wrap my-50">
                                        <div class="user-info-title">
                                            ...
                                            <span class="card-text user-info-title font-weight-bold mb-0">Operating System</span>
                                        </div>
                                        <p style="margin-left: auto;" class="card-text mb-0">Windows 10</p>
                                    </div>
                                    <div class="d-flex flex-wrap my-50">
                                        <div class="user-info-title">
                                            <i class="fas fa-server mr-1"></i>
                                            <span class="card-text user-info-title font-weight-bold mb-0">Operating System Version</span>
                                        </div>
                                        <p style="margin-left: auto;" class="card-text mb-0">10.0</p>
                                    </div>
                                    <div class="d-flex flex-wrap my-50">
                                        <div class="user-info-title">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Computer Details</h4>
                    </div>
                    <div class="card-body">
