<template>
    <!-- Modal -->
    <div class="modal fade" id="edit-url" tabindex="-1" role="dialog" aria-labelledby="edit-urlTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center" id="exampleModalCenterTitle">URL Details</h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" placeholder="URL Name" class="form-control" />
                    </div>

                    <label>Block Page: </label>
                    <div class="form-group">
