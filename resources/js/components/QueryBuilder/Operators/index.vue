                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="card-header border-bottom p-1">
                            <div class="head-label">
                                <h6 class="mb-0">Query Builder Operators</h6>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mx-0 row">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_filter mt-1" style="float: left;">
                                    <input type="search" class="form-control" placeholder="Search Type....." v-model="name" v-on:keyup="get_operators()" aria-controls="DataTables_Table_0">
                                    <input type="search" class="form-control" placeholder="Search OptGroup....." v-model="name" v-on:keyup="get_operators()" aria-controls="DataTables_Table_0">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="row d-flex" style="float: right;">
                                    <div class="col-md-8">
                                        <button style="margin-top: 7px;" class="btn btn-primary" data-toggle="modal" data-target="#add-operator">Add Operator</button>
                                    </div>
                                    <div class="col-md-4">
