    ...
    <div class="card">
      ...
      <div class="card-body">
        <p class="card-text">
          ...
          classes, where color can be any color from NA Query Builder Admin color palette.
        </p>
  ...
  <div class="row match-height">
    ...
    <div class="col-sm-12 col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">
            list of terms with icons, use <code>.list-style-icons</code> class. You can use any icon from NA Query Builder Admin
            icon types.
          </p>
