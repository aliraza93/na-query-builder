...
<head>
  ...
  <title>@yield('title') - NA Query Builder Vuejs, HTML & Laravel Admin Dashboard Template</title>
...
<body class="vertical-layout vertical-menu-modern {{ $configData['blankPageClass'] }} {{ $configData['bodyClass'] }} {{($configData['theme'] === 'dark') ? 'dark-layout' : 'light' }}
  ...
  <!-- BEGIN: Content-->
  <div class="app-content content {{ $configData['pageClass'] }}" style="margin: 0 auto; margin-top: -7%;">
