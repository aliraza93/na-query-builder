...
Route::middleware('auth')->group(function () {
  ...
  Route::group(['prefix' => 'ad-data'], function () {
      Route::get('users', 'AdDataController@user_list')->name('ad-data-users');
...
Route::group(['prefix' => 'auth'], function () {
  ...
  Route::get('forgot-password', 'AuthenticationController@forgot_password')->name('auth-forgot-password-v2');
